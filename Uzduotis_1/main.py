...
#     print("ILGAS būdas. Pirmos užduoties 1 dalies atsakymas, gražinu listą vartotojų, kurie arba neturi naminių gyvūnų
#     visiškai, arba turi ir šunį, ir katę: ")
...
# ''' 1 variantas.
# PAAIŠKNIMAS:  nors šis sprendimo būdas ilgesnis, bet naudingas, panaudosime pirmos funkcijos funkcijas, pakeisime tik
# filtro funkcija kai yra daugiau užduočių ir filtrų.
# ESMĖ: sukuriamos trys funkcijos, kurios saveikauja ir galiausiai gaunamas reikiamas rezultatas.  '''
#
...
#     ''' trečia funkcija kuri atspausdina sarašą'''
#     print("ILGAS būdas. Pirmos užduoties 2 dalies atsakymas, gražinu listą vartotojų, kurie  nėra pilnamečiai ir turi
#     bent vieną naminį gyvūną ")
#     return print(f" {return_list(list)}")
